              ...
              for (let i = 0; i < 3; i++) {
                ...
                $.get('https://www.omdbapi.com/?t=' + product)
                  .then(function(results) {
                      ...
                      $('.movieResults').append('<div class="card-content1"><button class="preview"><a class="link1" href="' + imdb + results.imdbRating + < /p></div
                        ');
                        //Amazon Link
                        $('.movieResults').append('<div class="card-action"><button class="amazon"><a class="link"href="' + amazon + product + '" target=' + next + '>' + here + '</a></button>') $('.movieResults').append('<div class="divide"></div>')
                      })
                  }
              })
